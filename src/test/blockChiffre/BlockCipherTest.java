...
class BlockCipherTest {
    ...
    /**
     * Test the main.encryption of a message to number blocks
     * bitLength: bitlength of prime for main.encryption -> 256
    ...
    /**
     * bitLength: bitlength of prime for main.encryption -> 512
     * numberSystemBase: base of the number system (g-adic system base) (e.g. 55296)
     * blockSize: block size for main.encryption

...
////            noMistake = noMistake && mathMethods.MathMethods.expandedEuklid(n1,n2).equals(n1.gcd(n2));
...
////            noMistake = noMistake && mathMethods.MathMethods.alternativeQuickExponentation(n,exp,mod).equals(n.modPow(exp,mod));
//            long start = System.nanoTime();
...
//        /*
//        System.out.println(mathMethods.MathMethods.expandedEuklid(new BigInteger("6267"), new BigInteger("354")));
//        System.out.println(mathMethods.MathMethods.expandedEuklid(new BigInteger("354"), new BigInteger("6267")));
//        System.out.println(mathMethods.MathMethods.expandedEuklid(new BigInteger("661643"), new BigInteger("315")));
//        System.out.println(mathMethods.MathMethods.expandedEuklid(new BigInteger("315"), new BigInteger("661643")));
//        System.out.println(mathMethods.MathMethods.expandedEuklid(new BigInteger("661643"), new BigInteger("661643")));
...
////        Create RSA encryption using mathMethods.MathMethods
//
...
////        BigInteger encryptedMessage = mathMethods.MathMethods.encrypt(message, e, n);
//        BigInteger encryptedMessage = MathMethods.alternativeQuickExponentiation(message, e, n);
//        System.out.println("Encrypted Message: " + encryptedMessage);
//
//        // Decryption
////        BigInteger decryptedMessage = mathMethods.MathMethods.decrypt(encryptedMessage, d, n);
